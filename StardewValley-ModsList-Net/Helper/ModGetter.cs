...
namespace StardewValleyModList.Helper
{
    ...
    {
        public static async Task<List<ManifestDataModel>> SearchMods(string path)
        {
            ...
            var manifestList = await GetModsManifest(modsListPath, manifestJsonFile);
        ...
        private static async Task<List<ManifestDataModel>> GetModsManifest(string[] modsListPaths, string manifestFilename)
        {
            List<ManifestDataModel> manifestData = new();
